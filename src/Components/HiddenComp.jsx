...
function HiddenComp({setIsActive}) {
    
  return (
    // {/* comp 1 */}
    <NavLink to='/basic-ui-elements' className='nav-hidden' >
         {({isActive})=>(
            setIsActive(isActive),
            console.log('2 '+isActive),
            <div className='hidden-comp'>
                ...
                <p className={isActive?'hide-p-active':'hide-p'}>Buttons</p>
            </div>
