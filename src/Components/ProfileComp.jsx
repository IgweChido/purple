    ...
    <div className='profile'>
        <div className='p-group'>
            ...
            <div className='profile-text'>
                <p className='name'>David Grey. H</p>
